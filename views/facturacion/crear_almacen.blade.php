                                        ...
                                        {{ Form::open(array('method' => 'POST','class' => 'row g-3 needs-validation','id' => 'defaultForm', 'url' => array('/productos/create'))) }}
                                            ...
                                            <div class="col-md-6 position-relative">
                                                <label for="validationTooltip02" class="form-label">Size</label>
                                                    ...
                                                    {{Form::text('size', '', array('class' => 'form-control','placeholder'=>'Enter Size'))}}
                                                    <div class="invalid-tooltip"> Please choose a unique and valid
                                                        username. </div>
                                             ...
                                             <div class="col-md-6 position-relative">
                                                <label for="validationTooltip02" class="form-label">Qty</label>
                                                    ...
                                                    {{Form::text('cantidad', '', array('class' => 'form-control','placeholder'=>'Enter Quantity'))}}
                                                    <div class="invalid-tooltip"> Please choose a unique and valid
                                                        username. </div>
                                            ...
                                            <div class="col-md-6 position-relative">
                                                <label for="validationTooltip03" class="form-label">Store</label>
